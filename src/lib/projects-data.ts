...
export const hblProjects: ProjectRow[] = [
    ...
    { id: 103, srNo: '3', projectName: 'HBL DHA GUJRANWALA', area: '4,028', projectHolder: 'Luqman', allocationDate: '6-Sep-25', siteSurveyStart: '4-Sep-25', siteSurveyEnd: '5-Sep-25', contactStart: 'Received', contactEnd: '', headCountStart: '', headCountEnd: '', proposalStart: '8-Sep-25', proposalEnd: '12-Sep-25', threedStart: '', threedEnd: '', tenderArchStart: '', tenderArchEnd: '', tenderMepStart: '', tenderMepEnd: '', boqStart: '', boqEnd: '', tenderStatus: 'Hold', comparative: '', workingDrawings: '', siteVisit: '', finalBill: '', projectClosure: '' },
...
export const ublProjects: ProjectRow[] = [
    { id: 201, srNo: '1', projectName: 'UBL Bhowana, Chiniot', area: '7,600.00', projectHolder: 'Adnan Luqman', allocationDate: '06-May-25', siteSurveyStart: '20-May-25', siteSurveyEnd: '21-May-25', contactStart: 'Done', contactEnd: '', headCountStart: '06-May-25', headCountEnd: '', proposalStart: '06-Jul-25', proposalEnd: 'Done', threedStart: '', threedEnd: '', tenderArchStart: '', tenderArchEnd: '', tenderMepStart: '', tenderMepEnd: '', boqStart: '', boqEnd: '', tenderStatus: '', comparative: '', workingDrawings: '', siteVisit: '', finalBill: '', projectClosure: '' },
    ...
    { id: 204, srNo: '4', projectName: 'UBL PHASE 6', area: '13,085.00', projectHolder: 'Adnan Haseeb', allocationDate: '06-Apr-24', siteSurveyStart: '', siteSurveyEnd: '', contactStart: 'Done', contactEnd: '', headCountStart: 'Done', headCountEnd: '', proposalStart: 'Done', proposalEnd: '', threedStart: '', threedEnd: '', tenderArchStart: 'Sent', tenderArchEnd: '', tenderMepStart: '', tenderMepEnd: 'Pending', boqStart: '', boqEnd: 'Pending', tenderStatus: 'Done', comparative: 'In Revision', workingDrawings: 'In Revision', siteVisit: '', finalBill: '', projectClosure: '' },
    { id: 205, srNo: '5', projectName: 'State Life Society', area: '6,691.00', projectHolder: 'Adnan Haseeb', allocationDate: '06-Mar-24', siteSurveyStart: '', siteSurveyEnd: '', contactStart: 'Done', contactEnd: '', headCountStart: 'Done', headCountEnd: '', proposalStart: 'Done', proposalEnd: '', threedStart: '', threedEnd: '', tenderArchStart: '', tenderArchEnd: '', tenderMepStart: '', tenderMepEnd: '', boqStart: '', boqEnd: '', tenderStatus: '', comparative: '', workingDrawings: '23-Oct-24', siteVisit: '28-Oct-24', finalBill: '', projectClosure: '' }
];
...
export const dibProjects: ProjectRow[] = [
     { id: 501, srNo: '1', projectName: 'DUBAI ISLAMIC BANK LHR', area: '7,550.00', projectHolder: 'ASAD MUJAHID', allocationDate: '19-Sep-25', siteSurveyStart: '20-Sep-25', siteSurveyEnd: '20-Sep-25', contactStart: '', contactEnd: '', headCountStart: 'DONE', headCountEnd: '', proposalStart: '24-Sep-25', proposalEnd: '28-Sep-25', threedStart: '3-Oct-25', threedEnd: '3-Nov-25', tenderArchStart: '', tenderArchEnd: '', tenderMepStart: '', tenderMepEnd: '', boqStart: '', boqEnd: '', tenderStatus: '', comparative: '', workingDrawings: '', siteVisit: '', finalBill: '', projectClosure: '' }
];

export const bankAlfalahProjects: ProjectRow[] = [
    { id: 601, srNo: '1', projectName: 'BALF Currency Exchange Dolmen Mall Lahore', area: '800.00', projectHolder: 'Haseeb', allocationDate: '26-May-25', siteSurveyStart: '04-Apr-25', siteSurveyEnd: '04-Apr-25', contactStart: 'Received', contactEnd: '', headCountStart: '', headCountEnd: '', proposalStart: '05-Apr-25', proposalEnd: '11-Apr-25', threedStart: '14-Apr-25', threedEnd: '18-Apr-25', tenderArchStart: '', tenderArchEnd: '', tenderMepStart: '10-Sep-25', tenderMepEnd: '', boqStart: '', boqEnd: '', tenderStatus: 'Sent', comparative: '', workingDrawings: '', siteVisit: '', finalBill: '', projectClosure: '' },

...
export const ublProjects: ProjectRow[] = [
    ...
    { id: 204, srNo: '4', projectName: 'UBL PHASE 6', area: '13,085.00', projectHolder: 'Adnan Haseeb', allocationDate: '6-april-24', siteSurveyStart: '', siteSurveyEnd: '', contactStart: 'Done', contactEnd: '', headCountStart: 'Done', headCountEnd: '', proposalStart: 'Done', proposalEnd: '', threedStart: '', threedEnd: '', tenderArchStart: 'Sent', tenderArchEnd: '', tenderMepStart: '', tenderMepEnd: 'Pending', boqStart: '', boqEnd: 'Pending', tenderStatus: 'Done', comparative: 'In Revision', workingDrawings: 'In Revision', siteVisit: '', finalBill: '', projectClosure: '' },

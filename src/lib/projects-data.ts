...
export const ublProjects: ProjectRow[] = [
    { id: 201, srNo: '1', projectName: 'UBL Regional HQ, Lahore', area: '120,000', projectHolder: 'Isbah Hassan', allocationDate: '1-Jan-24', siteSurveyStart: 'Completed', siteSurveyEnd: '', contactStart: 'Completed', contactEnd: '', headCountStart: 'Completed', headCountEnd: '', proposalStart: 'Completed', proposalEnd: '', threedStart: 'Completed', threedEnd: '', tenderArchStart: 'Completed', tenderArchEnd: '', tenderMepStart: 'Completed', tenderMepEnd: '', boqStart: 'Completed', boqEnd: '', tenderStatus: 'Awarded', comparative: 'Done', workingDrawings: 'In-Progress', siteVisit: 'Ongoing', finalBill: '', projectClosure: '' },
    { id: 202, srNo: '2', projectName: 'UBL Blue Area, Islamabad', area: '5,000', projectHolder: 'Asad', allocationDate: '10-Mar-25', siteSurveyStart: '12-Mar-25', siteSurveyEnd: '14-Mar-25', contactStart: '', contactEnd: '', headCountStart: '', headCountEnd: '', proposalStart: '20-Mar-25', proposalEnd: '30-Mar-25', threedStart: '', threedEnd: '', tenderArchStart: '', tenderArchEnd: '', tenderMepStart: '', tenderMepEnd: '', boqStart: '', boqEnd: '', tenderStatus: '', comparative: '', workingDrawings: '', siteVisit: '', finalBill: '', projectClosure: '' },
    { id: 203, srNo: '3', projectName: 'UBL Saddar, Rawalpindi', area: '4,500', projectHolder: 'Waleed', allocationDate: '1-Apr-25', siteSurveyStart: '', siteSurveyEnd: '', contactStart: '', contactEnd: '', headCountStart: '', headCountEnd: '', proposalStart: '', proposalEnd: '', threedStart: '', threedEnd: '', tenderArchStart: '', tenderArchEnd: '', tenderMepStart: '', tenderMepEnd: '', boqStart: '', boqEnd: '', tenderStatus: '', comparative: '', workingDrawings: '', siteVisit: '', finalBill: '', projectClosure: '' },
    { id: 204, srNo: '4', projectName: 'UBL Clifton, Karachi', area: '6,200', projectHolder: 'Kizzar', allocationDate: '15-May-25', siteSurveyStart: '', siteSurveyEnd: '', contactStart: '', contactEnd: '', headCountStart: '', headCountEnd: '', proposalStart: '', proposalEnd: '', threedStart: '', threedEnd: '', tenderArchStart: '', tenderArchEnd: '', tenderMepStart: '', tenderMepEnd: '', boqStart: '', boqEnd: '', tenderStatus: '', comparative: '', workingDrawings: '', siteVisit: '', finalBill: '', projectClosure: '' },
    { id: 205, srNo: '5', projectName: 'UBL Z-Block, DHA Lahore', area: '3,800', projectHolder: 'Luqman', allocationDate: '20-Jun-25', siteSurveyStart: '', siteSurveyEnd: '', contactStart: '', contactEnd: '', headCountStart: '', headCountEnd: '', proposalStart: '', proposalEnd: '', threedStart: '', threedEnd: '', tenderArchStart: '', tenderArchEnd: '', tenderMepStart: '', tenderMepEnd: '', boqStart: '', boqEnd: '', tenderStatus: '', comparative: '', workingDrawings: '', siteVisit: '', finalBill: '', projectClosure: '' },
];

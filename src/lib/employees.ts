...
export const employees: Employee[] = [
  ...
  { uid: 'user6', name: 'Waqas Rasool', contact: '0321-5564674', email: 'waqas.rasool@ri-hub.com', record: 'EMP-006', avatarId: 'avatar-2', departments: ['finance', 'admin'], password: 'password' },

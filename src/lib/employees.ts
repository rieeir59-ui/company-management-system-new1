...
export const employees: Employee[] = [
  ...
  { uid: 'user4', name: 'Rabiya Eman', contact: '0302-2774442', email: 'rabiya.eman@ri-hub.com', record: 'EMP-004', avatarId: 'avatar-1', department: 'admin', password: 'password' },
  { uid: 'user5', name: 'Imran Abbas', contact: '0325-5382699', email: 'imran.abbas@ri-hub.com', record: 'EMP-005', avatarId: 'avatar-2', department: 'admin', password: 'password' },

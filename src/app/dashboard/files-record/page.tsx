...
export default function FilesRecordPage() {
  ...
  const canEditOrDelete = (file: UploadedFile) => {
    if (!currentUser) return false;
    const isAdmin = ['admin', 'software-engineer', 'ceo'].includes(currentUser.department);
    return isAdmin || currentUser.record === file.employeeId;
  };
                ...
                <CardHeader>
                  <div className="flex items-center gap-3">
                      ...
                      <div>
                          ...
                          <CardDescription>Documents uploaded under the {name.toLowerCase()} category.</CardDescription>
                      </div>
                  </div>
                </CardHeader>
                <CardContent>

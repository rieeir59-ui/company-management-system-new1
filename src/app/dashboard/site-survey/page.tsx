                ...
                <CardContent>
                    <form id="site-survey-form" className="space-y-8">
                        ...
                        <SectionTable title="Building overview">
                            ...
                            <FormRow label="Emergency Exit if not available can be provided or not">
                                <div className="flex items-center space-x-8"><div className="flex items-center space-x-2"><Checkbox id="emergency_exit_provision_yes" name="emergency_exit_provision_yes" checked={!!formState['emergency_exit_provision_yes']} onCheckedChange={(c) => handleCheckboxChange('emergency_exit_provision_yes', !!c)} /><Label htmlFor="emergency_exit_provision_yes">Yes</Label></div><div className="flex items-center space-x-2"><Checkbox id="emergency_exit_provision_no" name="emergency_exit_provision_no" checked={!!formState['emergency_exit_provision_no']} onCheckedChange={(c) => handleCheckboxChange('emergency_exit_provision_no', !!c)} /><Label htmlFor="emergency_exit_provision_no">No</Label></div></div>
                            </FormRow>
                            <FormRow label="Ramp available">
                                <div className="flex items-center space-x-8"><div className="flex items-center space-x-2"><Checkbox id="ramp_available_yes" name="ramp_available_yes" checked={!!formState['ramp_available_yes']} onCheckedChange={(c) => handleCheckboxChange('ramp_available_yes', !!c)} /><Label htmlFor="ramp_available_yes">Yes</Label></div><div className="flex items-center space-x-2"><Checkbox id="ramp_available_no" name="ramp_available_no" checked={!!formState['ramp_available_no']} onCheckedChange={(c) => handleCheckboxChange('ramp_available_no', !!c)} /><Label htmlFor="ramp_available_no">No</Label></div></div>
                            </FormRow>
                            <FormRow label="Ramp if not available can be provided or not">
                                <div className="flex items-center space-x-8"><div className="flex items-center space-x-2"><Checkbox id="ramp_provision_yes" name="ramp_provision_yes" checked={!!formState['ramp_provision_yes']} onCheckedChange={(c) => handleCheckboxChange('ramp_provision_yes', !!c)} /><Label htmlFor="ramp_provision_yes">Yes</Label></div><div className="flex items-center space-x-2"><Checkbox id="ramp_provision_no" name="ramp_provision_no" checked={!!formState['ramp_provision_no']} onCheckedChange={(c) => handleCheckboxChange('ramp_provision_no', !!c)} /><Label htmlFor="ramp_provision_no">No</Label></div></div>
                            </FormRow>
                            <FormRow label="Seepage">
                                <div className="flex items-center space-x-8"><div className="flex items-center space-x-2"><Checkbox id="seepage_yes" name="seepage_yes" checked={!!formState['seepage_yes']} onCheckedChange={(c) => handleCheckboxChange('seepage_yes', !!c)} /><Label htmlFor="seepage_yes">Yes</Label></div><div className="flex items-center space-x-2"><Checkbox id="seepage_no" name="seepage_no" checked={!!formState['seepage_no']} onCheckedChange={(c) => handleCheckboxChange('seepage_no', !!c)} /><Label htmlFor="seepage_no">No</Label></div></div>
                            </FormRow>
                            ...
                            <FormRow label="Generator installation space">
                                <div className="flex items-center space-x-8"><div className="flex items-center space-x-2"><Checkbox id="generator_space_yes" name="generator_space_yes" checked={!!formState['generator_space_yes']} onCheckedChange={(c) => handleCheckboxChange('generator_space_yes', !!c)} /><Label htmlFor="generator_space_yes">Yes at back or left side</Label></div><div className="flex items-center space-x-2"><Checkbox id="generator_space_no" name="generator_space_no" checked={!!formState['generator_space_no']} onCheckedChange={(c) => handleCheckboxChange('generator_space_no', !!c)} /><Label htmlFor="generator_space_no">No</Label></div></div>
                            </FormRow>
                            ...
                            <FormRow label="Is area susceptible to flooding during rain fall">
                                <div className="flex items-center space-x-8"><div className="flex items-center space-x-2"><Checkbox id="flooding_yes" name="flooding_yes" checked={!!formState['flooding_yes']} onCheckedChange={(c) => handleCheckboxChange('flooding_yes', !!c)} /><Label htmlFor="flooding_yes">Yes</Label></div><div className="flex items-center space-x-2"><Checkbox id="flooding_no" name="flooding_no" checked={!!formState['flooding_no']} onCheckedChange={(c) => handleCheckboxChange('flooding_no', !!c)} /><Label htmlFor="flooding_no">No</Label></div></div>
                            </FormRow>
                             <FormRow label="Disable access available or can be provided">
                                <div className="flex items-center space-x-8"><div className="flex items-center space-x-2"><Checkbox id="disable_access_yes" name="disable_access_yes" checked={!!formState['disable_access_yes']} onCheckedChange={(c) => handleCheckboxChange('disable_access_yes', !!c)} /><Label htmlFor="disable_access_yes">Yes</Label></div><div className="flex items-center space-x-2"><Checkbox id="disable_access_no" name="disable_access_no" checked={!!formState['disable_access_no']} onCheckedChange={(c) => handleCheckboxChange('disable_access_no', !!c)} /><Label htmlFor="disable_access_no">No</Label></div></div>
                            </FormRow>
                            ...
                            <FormRow label="Parking available">
                               <div className="flex items-center space-x-8"><div className="flex items-center space-x-2"><Checkbox id="parking_yes" name="parking_yes" checked={!!formState['parking_yes']} onCheckedChange={(c) => handleCheckboxChange('parking_yes', !!c)} /><Label htmlFor="parking_yes">Yes</Label></div><div className="flex items-center space-x-2"><Checkbox id="parking_no" name="parking_no" checked={!!formState['parking_no']} onCheckedChange={(c) => handleCheckboxChange('parking_no', !!c)} /><Label htmlFor="parking_no">No</Label></div></div>
                            </FormRow>

        ...
        try {
            ...
            const updatedProjectRows = projectRows.map(row => {
                if (row.projectName.toLowerCase() === genProjectName.toLowerCase()) {
                    return {
                        ...
                        architecturalDrawingsStart: taskMap['tenderpackagearchitectural']?.start || row.architecturalDrawingsStart,
                        architecturalDrawingsEnd: taskMap['tenderpackagearchitectural']?.end || row.architecturalDrawingsEnd,
                        mepDrawingsStart: taskMap['tenderpackagemep']?.start || row.mepDrawingsStart,
                        mepDrawingsEnd: taskMap['tenderpackagemep']?.end || row.mepDrawingsEnd,
            ...
            if (!projectExists) {
                 ...
                 const newRow: ProjectRow = {
                    ...
                    architecturalDrawingsStart: taskMap['tenderpackagearchitectural']?.start || '',
                    architecturalDrawingsEnd: taskMap['tenderpackagearchitectural']?.end || '',
                    mepDrawingsStart: taskMap['tenderpackagemep']?.start || '',
                    mepDrawingsEnd: taskMap['tenderpackagemep']?.end || '',

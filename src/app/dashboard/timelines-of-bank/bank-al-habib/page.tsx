...
const initialProjectRows: ProjectRow[] = [
    { id: 1, srNo: '1', projectName: 'Bank Al Habib CLIFTON BRANCH', area: '5,500.00', projectHolder: '', allocationDate: '13-Oct-25', siteSurveyStart: '', siteSurveyEnd: '', contactStart: 'DONE', contactEnd: '', headCountStart: '14-Oct-25', headCountEnd: '', proposalStart: '', proposalEnd: '', threedStart: '', threedEnd: '', tenderArchStart: '', tenderArchEnd: '', tenderMepStart: '', tenderMepEnd: '', boqStart: '', boqEnd: '', tenderStatus: '', comparative: '', workingDrawings: '', siteVisit: '', finalBill: '', projectClosure: '' },
    { id: 2, srNo: '2', projectName: 'Khyaban-e-Hafiz Office and Branch', area: '13,500.00', projectHolder: '', allocationDate: '13-Oct-25', siteSurveyStart: '', siteSurveyEnd: '', contactStart: 'DONE', contactEnd: '', headCountStart: '14-Oct-25', headCountEnd: '', proposalStart: '', proposalEnd: '', threedStart: '', threedEnd: '', tenderArchStart: '', tenderArchEnd: '', tenderMepStart: '', tenderMepEnd: '', boqStart: '', boqEnd: '', tenderStatus: '', comparative: '', workingDrawings: '', siteVisit: '', finalBill: '', projectClosure: '' },
];
...
export default function BankAlHabibTimelinePage() {
    ...
    const handleSave = () => {
        ...
        toast({ title: 'Saved', description: 'Bank Al Habib timeline data has been saved.' });
    };

...
function BankAlfalahTimelineComponent() {
    ...
    const handleSave = () => {
        addRecord({
            fileName: 'Bank Alfalah Project Chart',
    ...
    const handleDownload = () => {
        ...
        doc.setFontSize(10);
        doc.text("Bank Alfalah Project Chart", 14, 15);
    ...
    return (
        <Card>
            <CardHeader className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <CardTitle className="text-center font-headline text-3xl text-primary">Bank Alfalah Project Chart</CardTitle>

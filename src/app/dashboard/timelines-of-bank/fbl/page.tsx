...
import { fblProjects as initialProjectRowsData, type ProjectRow } from '@/lib/projects-data';
...
function FBLTimelineComponent() {
    ...
    const handleSave = () => {
        addRecord({
            fileName: 'FBL Project Chart',
            projectName: 'FBL Projects',
            data: [
    ...
    const handleDownload = () => {
        ...
        doc.setFontSize(10);
        doc.text("Faysal Bank Limited (FBL) Project Chart", 14, 15);
    ...
    return (
        <Card>
            <CardHeader className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <CardTitle className="text-center font-headline text-3xl text-primary">Faysal Bank Limited (FBL) Project Chart</CardTitle>

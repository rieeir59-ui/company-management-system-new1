...
function BankAlfalahTimelineComponent() {
    ...
    useEffect(() => {
        const savedData = localStorage.getItem('bankAlfalahProjects');
        if (savedData) {
    ...
    useEffect(() => {
        localStorage.setItem('bankAlfalahProjects', JSON.stringify(projectRows));
    }, [projectRows]);
                        ...
                        <tbody>
                            {projectRows.map(row => (
                                <tr key={row.id}>
                                    ...
                                    <td className="border"><Input type="text" value={row.allocationDate} onChange={e => handleProjectChange(row.id, 'allocationDate', e.target.value)} disabled={editingRowId !== row.id} className="w-28" /></td>
                                    ...
                                    <td className="border"><Input type="text" value={row.contactStart} onChange={e => handleProjectChange(row.id, 'contactStart', e.target.value)} disabled={editingRowId !== row.id} /></td>
                                    <td className="border"><Input type="text" value={row.contactEnd} onChange={e => handleProjectChange(row.id, 'contactEnd', e.target.value)} disabled={editingRowId !== row.id} /></td>
                                    <td className="border"><Input type="text" value={row.headCountStart} onChange={e => handleProjectChange(row.id, 'headCountStart', e.target.value)} disabled={editingRowId !== row.id} /></td>
                                    <td className="border"><Input type="text" value={row.headCountEnd} onChange={e => handleProjectChange(row.id, 'headCountEnd', e.target.value)} disabled={editingRowId !== row.id} /></td>

...
import { ublProjects as initialProjectRowsData, type ProjectRow } from '@/lib/projects-data';
...
function UBLTimelineComponent() {
    ...
    const handleDownload = () => {
        ...
        doc.setFontSize(10);
        doc.text("UBL Project Chart", 14, 15);
    ...
    return (
        <Card>
            <CardHeader className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <CardTitle className="text-center font-headline text-3xl text-primary">UBL Project Chart</CardTitle>

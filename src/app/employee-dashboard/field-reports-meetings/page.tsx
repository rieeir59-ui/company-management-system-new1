...
const reportTypes = [
    {
        ...
        href: "/employee-dashboard/field-reports-meetings/architects-field-report",
        icon: FileText
    },
    {
        title: "Transmittal Letter",
        description: "Create and send formal transmittal letters.",
        href: "/employee-dashboard/field-reports-meetings/transmittal-letter",
        icon: Send
    },
    {
        title: "Minutes of Meetings",
        description: "Record decisions and action items from meetings.",
        href: "/employee-dashboard/field-reports-meetings/minutes-of-meetings",
        icon: Users
    }
];

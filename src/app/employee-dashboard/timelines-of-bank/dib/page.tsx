...
import { dibProjects as initialProjectRowsData, type ProjectRow, deleteProject } from '@/lib/projects-data';
import Link from 'next/link';

function DIBTimelineComponent() {
    ...
    const [remarksDate, setRemarksDate] = useState('');
     ...
     useEffect(() => {
        const savedData = localStorage.getItem('dibProjects');
        if (savedData) {
    ...
    useEffect(() => {
        localStorage.setItem('dibProjects', JSON.stringify(projectRows));
    }, [projectRows]);

...
import { hblProjects as initialProjectRowsData, type ProjectRow, deleteProject } from '@/lib/projects-data';
...
function HBLTimelineComponent() {
    ...
    useEffect(() => {
        const savedData = localStorage.getItem('hblProjects');
        if (savedData) {
    ...
    useEffect(() => {
        localStorage.setItem('hblProjects', JSON.stringify(projectRows));
    }, [projectRows]);

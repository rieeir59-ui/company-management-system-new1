...
import { ublProjects as initialProjectRowsData, type ProjectRow, deleteProject } from '@/lib/projects-data';
...
function UBLTimelineComponent() {
    ...
    useEffect(() => {
        const savedData = localStorage.getItem('ublProjects');
        if (savedData) {
    ...
    useEffect(() => {
        localStorage.setItem('ublProjects', JSON.stringify(projectRows));
    }, [projectRows]);

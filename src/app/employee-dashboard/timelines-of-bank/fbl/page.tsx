...
function FBLTimelineComponent() {
    ...
    const handleDownload = () => {
        ...
        doc.setFontSize(10);
        doc.text("Faysal Bank Limited (FBL) Timeline", 14, 15);
    ...
    return (
        <Card>
            <CardHeader className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <CardTitle className="text-center font-headline text-3xl text-primary">Faysal Bank Limited (FBL) Timeline</CardTitle>
